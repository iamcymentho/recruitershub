        ...
        class="bg-gray-50 shadow border border-gray-200 p-10 rounded max-w-lg mx-auto mt-24"
                >
                    ...
                    <form action="/listings/{{ $listing->id }}" method="POST" enctype="multipart/form-data">
                        ...
                        {{-- Laravels provided method for editing. It cant be used in the form method. Only GET or POST goes in there --}}
                        ...
                        <div class="mb-6">
                            ...
                            @error('company')
                            <p class="text-red-500 text-xs mt-1"><b>{{ $message }}</b></p>    
                            @enderror
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            {{-- showing the former picture/logo for editing --}}
                 ...
                 <button class="bg-laravel shadow text-white rounded py-2 px-4 hover:bg-black" ><i class="fa-solid fa-circle-plus"></i> Update Gig </button>
